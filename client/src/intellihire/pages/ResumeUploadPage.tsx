...
export default function ResumeUploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const { id } = await upload(file); // <-- backend returns { id }
      if (!id) throw new Error("Invalid API response");

      setProgress(100);
      setToast("Upload successful — analyzing your resume...");
    ...
    <div className="text-gray-800 dark:text-gray-200 pt-24 min-h-screen px-4 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold bg-gradient-to-r from-blue-600 to-blue-400 
                         dark:from-blue-300 dark:to-blue-500 bg-clip-text text-transparent">
        ...
        <Card className="p-20 rounded-2xl backdrop-blur-xl border border-gray-200 dark:border-gray-700 shadow-xl hover:bg-gray-100 dark:hover:bg-gray-700">
